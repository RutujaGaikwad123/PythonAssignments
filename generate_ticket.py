...
airline = AI                           ['AI:Ban:Lon:106',
source = Bangalore                     'AI:Ban:Lon:107',
destination = London                    'AI:Ban:Lon:108',
no_of_passengers = 10                  'AI:Ban:Lon:109', 'AI:Ban:Lon:110']

airline = BA                           ['BA:Aus:Fra:101',
source = Australia                      'BA:Aus:Fra:102']
destination = France
no_of_passengers = 2
